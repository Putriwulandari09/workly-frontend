...
function EditJob() {
  ...
  const [form, setForm] = useState({
    ...
    description: "Lowongan untuk backend developer dengan pengalaman minimal 2 tahun.",
  });
  ...
  const handleSubmit = (event) => {
    ...
    alert(`Lowongan ${form.title} berhasil diperbarui.`);
    navigate("/admin/jobs");
  };
  ...
  return (
    <>
      <div className="mb-4">
        ...
        <p className="text-muted mb-0">Perbarui detail lowongan untuk id: {id}.</p>
      </div>
